...
myFold = dir(".\TRAIN\barrufets\*.jpg");
%%
for i = 1:numImages
    try    
...
%%
save('MatBob.mat', 'redHistograms', 'greenHistograms', "hogFeatures", 'clase');

%%
load('MatBob.mat');

%%
Feature = table(clase, greenHistograms, redHistograms, hogFeatures, ...
    'VariableNames', {'Class', 'GreenHisto','RedHisto', 'HogHist'});